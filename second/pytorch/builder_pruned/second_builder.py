...
from second.pytorch.models_pruned.voxelnet import LossNormType, VoxelNet


def build(model_cfg: second_pb2.VoxelNet, voxel_generator, target_assigner, batch_size, cfg = None) -> VoxelNet:
