...
def split_datasets(ids_p, num):
    ...
    with open('train_shpr_single_10644.txt', 'w') as f:
    ...
    with open('val_shpr_single_10644.txt', 'w') as f:
        f.write(str_val_ids)
    ...
    with open("trainval_shpr_single_10644.txt", 'w') as f:
...
if __name__ == '__main__':
    ids_path = "/nfs/nas/datasets/songhongli/neolix_shanghai_5975/training/label_2/"
    num = 5976
