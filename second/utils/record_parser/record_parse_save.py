...
def define_destinations(parse_dict):
    ...
    #dest_dict['destination_folder'] = "/home/caros/part3_right/"
...
def parse_apollo_record(parse_dict, dest_dict, parser_func):
    ...
    for rfile in record_files:
        ...
        #with open("/home/caros/part3_right_timestamp.txt", 'w+') as f:
        with open(dest_dict["timestamp_file"], 'w+') as f:
            # print("time_stamp is writen to" + dest_dict["timestamp_file"])
